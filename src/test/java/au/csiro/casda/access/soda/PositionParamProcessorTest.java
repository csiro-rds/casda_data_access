    ...
    public static class ValidatePositionValidTest
    {
        ...
        public static Collection<Object[]> data()
        {
            ...
            return Arrays.asList(new Object[][] { { "CIRCLE 12.0 34.0 0.5" }, { "CIRCLE +182.5 -34.0 7.5" },
                    { "CIRCLE 1.9461733726797e02 -4.9419355920530e01 0.05" },
                    { "CIRCLE 1.9461733726797e+02 -4.9419355920530e+01 0.05" },
    ...
    public static class ValidatePositionInvalidTest
    {
        ...
        public static Collection<Object[]> data()
        {
            ...
            return Arrays.asList(new Object[][] { { "CIRCLE 12.0 34.0 0.5 7" }, { "CIRCLE +182.5 -34.0" },
                    ...
                    { "RANGE 0 270 -inf 40" }, { "RANGE 0 270 40 -inF" }, { "RANGE 50.0/60.0 -24.0/-30.0" },
                    { "RANGE 320.9/321.9 55.54/55.56" }, { "POLYGON 12.0 34.0 14.0 35.0" },
                    { "POLYGON 112.0 34.0 118.0 36 118.0 -10.0 112.0 -10.0 89.0" },
                    { "POLYGON 12.0 34.0 14.0 35.0 NaN 17" }, { "POLYGON 12.0 34.0 14.0 35.0 17 NaN" },
                    { "circle 1.9461733726797e+02 -4.9419355920530e+01 0.05" },
                    { "range 12.0 12.5 34.0 36.0" }, { "polygon 12.0 34.0 14.0 35.0 14.0 36.0 12.0 35.0" }});
        }
