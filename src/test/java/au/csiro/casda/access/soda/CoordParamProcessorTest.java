...
public class CoordParamProcessorTest
{
    ...
    public static class ValidateCoordValidTest
    {
        ...
        /**
         * Test method for
         * {@link au.csiro.casda.access.soda.CoordParamProcessor#validate(java.lang.String[])}.
         */
        @Test
    ...
    public static class GetRangesForAxisTest
    {
        ...
        public void testEmpty()
        {
            ...
            assertThat(CoordParamProcessor.getRangesForAxis(null, "foo", orderedParams), is(empty()));
            assertThat(CoordParamProcessor.getRangesForAxis(new String[0], "foo", orderedParams), is(empty()));
        }
        ...
        public void testSingle()
        {
            ...
            List<ValueRange> velRanges = CoordParamProcessor.getRangesForAxis(coordParams, "vel-helo", orderedParams);
            assertThat(velRanges, contains(new ValueRange(17.5, 18.3)));
            assertThat(orderedParams, contains("COORD=VEL-HELO 17.5 18.3"));
        }
        ...
        public void testSingleDifferentAxis()
        {
            List<String> orderedParams = new ArrayList<>();
            String[] coordParams = new String[] { "VEL-HELO 17.5 18.3" };
            List<ValueRange> velRanges = CoordParamProcessor.getRangesForAxis(coordParams, "band", orderedParams);
            assertThat(velRanges, is(empty()));
            assertThat(orderedParams, is(empty()));
        }
        ...
        public void testMultiple()
        {
            ...
            assertThat(orderedParams, contains("COORD=VEL-HELO 17.5 18.3", "COORD=VEL-HELO 35 40"));
        }
        ...
        public void testMultipleVariousAxes()
        {
            ...
            velRanges = CoordParamProcessor.getRangesForAxis(coordParams, "FREQ", orderedParams);
            assertThat(velRanges, contains(new ValueRange(800E6, 850E6)));
            assertThat(orderedParams,
                    contains("COORD=VEL-HELO 17.5 18.3", "COORD=VEL-HELO 35 40", "COORD=FREQ 800E6 850E6"));
