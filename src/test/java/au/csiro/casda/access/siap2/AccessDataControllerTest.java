...
public class AccessDataControllerTest
{
    ...
    public static class SyncDownloadDataProductTest
    {
        ...
        public void setUp() throws Exception
        {
            ...
            DataAccessService dataAccessService = new DataAccessService(dataAccessJobRepository, imageCubeRepository,
                    mock(MeasurementSetRepository.class), cachedFileRepository, ngasService,
                    cacheDir.getRoot().getAbsolutePath(), archiveStatusCommandAndArgs, new JavaProcessJobFactory());
            controller = new AccessDataController(mock(HealthEndpoint.class), mock(SystemStatus.class),
        ...
        {
            String id = Utils.encryptAesUrlSafe("cube-1|myUserId|OPAL|123", secretKey);
            int sbid = 445;
            ...
            job.setId(jobId);
            job.setDownloadMode(CasdaDownloadMode.SIAP_SYNC);
            ...
            when(accessJobManager.getJobStatus(requestId)).thenReturn(AccessJobManager.createUWSJob(requestId,
        ...
        public void testFileInCacheCheckTimesOutAndFailsIfCancelFails() throws Exception
        {
            ...
            exception.expectCause(hasMessage(
                    equalTo("Could not cancel job created to refresh SIAP SYNC files in request after timeout. "
    ...
    public static class CreateJobTest
    {
        ...
        {
            String id = Utils.encryptAesUrlSafe("cube-1|myUserId|OPAL|c", secretKey);
        ...
        {
            String id = Utils.encryptAesUrlSafe("cubey-1|myUserId|OPAL|123", secretKey);
        ...
        {
            String id = Utils.encryptAesUrlSafe("catalogue-1|myUserId|OPAL|123", secretKey);
        ...
        {
            String id = Utils.encryptAesUrlSafe("cube-a|myUserId|OPAL|123", secretKey);
        ...
        public void testEncryptedIdKnownCubeDataProduct() throws Exception
        {
            ...
            assertThat(jobDto.getDownloadMode(), is(equalTo(CasdaDownloadMode.SIAP_ASYNC)));
        ...
        {
            String id = Utils.encryptAesUrlSafe("visibility-1|myUserId|NEXUS|123", secretKey);
        ...
        {
            String id1 = Utils.encryptAesUrlSafe("cube-1|myUserId|OPAL|123", secretKey);
            String id2 = Utils.encryptAesUrlSafe("visibility-1|myUserId|OPAL|123", secretKey);
            String id3 = Utils.encryptAesUrlSafe("cube-2|myUserId|OPAL|123", secretKey);
        ...
        {
            String id1 = Utils.encryptAesUrlSafe("cube-1|myUserId|OPAL|123", secretKey);
            String id2 = Utils.encryptAesUrlSafe("visibility-1|myUserId|NEXUS|123", secretKey);
        ...
        {
            String id1 = Utils.encryptAesUrlSafe("cube-1|myUserId1|OPAL|123", secretKey);
            String id2 = Utils.encryptAesUrlSafe("visibility-1|myUserId2|OPAL|123", secretKey);
    ...
    public static class GetJobTest
    {
        ...
        public void testNonExpiredJob() throws Exception
        {
            ...
            when(accessJobManager.getJobStatus(jobId))
    ...
    public static class SetJobPhaseTest
    {
        ...
        public void testAbort() throws Exception
        {
            ...
            when(accessJobManager.getJobStatus(jobId)).thenReturn(job);
    ...
    public static class ValidateParametersTest
    {
        ...
        public void setUp() throws Exception
        {
            ...
            imageCubeId = Utils.encryptAesUrlSafe("cube-1|differentUserId|OPAL|123", secretKey);
            ...
            dataProductId = Utils.encryptAesUrlSafe("cube-2|myUserId|NEXUS|123", secretKey);
            dataProductId2 = Utils.encryptAesUrlSafe("cube-2|differentUserId|OPAL|123", secretKey);

            when(dataAccessJobRepository.findByRequestId(jobId)).thenReturn(dataAccessJob);
            when(accessJobManager.getJobStatus(jobId)).thenReturn(uwsJob);
