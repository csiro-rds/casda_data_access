...
public class AsyncFunctionalTest
{
    ...
    public void setUp() throws Exception
    {
        ...
        accessUwsFactory =
                new TestAccessUwsFactory(dataAccessService, packager, hoursToExpiryDefault, hoursToExpirySiapSync);
        manager = new AccessJobManager(emf, dataAccessJobRepository, imageCubeRepository, catalogueRepository,
                ...
                cutoutService, null, "uwsBaseUrl", 1, 1, 2, 3, MAX_SMALL_JOB_SIZE_KB, fileDownloadBaseUrl);
        manager.init();
    ...
    {
        String dataProductId = Utils.encryptAesUrlSafe("cube-2|myUserId|NEXUS|123", secretKey);
        String dataProductId2 = Utils.encryptAesUrlSafe("visibility-10|myUserId|NEXUS|123", secretKey);
    ...
    {
        String id = Utils.encryptAesUrlSafe("cube-1|myUserId|NEXUS|123", secretKey);
    ...
    {
        String imageCubeId1 = Utils.encryptAesUrlSafe("cube-1|myUserId|NEXUS|123", secretKey);
        String imageCubeId2 = Utils.encryptAesUrlSafe("cube-2|myUserId|NEXUS|123", secretKey);
        String measurementSetId1 = Utils.encryptAesUrlSafe("visibility-1|myUserId|NEXUS|123", secretKey);
        String measurementSetId2 = Utils.encryptAesUrlSafe("visibility-2|myUserId|NEXUS|123", secretKey);
    ...
    public void testBulkParameterChanges() throws Exception
    {
        ...
        result = this.mockMvc.perform(get(location + "/parameters")).andExpect(status().isOk()).andReturn();
        assertThat(result.getResponse().getContentAsString(),
                containsString("<uws:parameter id=\"id\"><![CDATA[dJz-LNHpR8XP3DMW9-Yo5s7YcKosJ1WD3JWNL_eUBDs]]>"
                        + "</uws:parameter>"));
        assertThat(result.getResponse().getContentAsString(), anyOf(
                containsString("<uws:parameter id=\"pos\"><![CDATA[{CIRCLE 1 2 3,RANGE 135 136.1 -45.56 -46.23}]]>"
                        + "</uws:parameter>"),
