...
public class BandParamProcessor implements CutoutParamProcessor
{
    ...
    private static final String ERROR_MESSAGE_NOT_TWO_VALUES = "Your query contained an invalid band format. "
    ...
    public List<String> validate(String[] values)
    {
        ...
        for (String param : values)
        {
            ...
            else if (testParam.length() != 0 && !Pattern.matches(SINGLE_NUMERIC_VALUE_PATTERN, testParam)
