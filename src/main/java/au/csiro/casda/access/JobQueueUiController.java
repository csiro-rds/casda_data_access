...
public class JobQueueUiController
{
     ...
     */
    static final String JOB_QUEUE_PAGE = "jobManagerQueue";
     ...
     * @return an exception
     */
    @RequestMapping(method = RequestMethod.GET, value = "/queuedJobs")
     ...
     */
    @RequestMapping(method = RequestMethod.GET, value = "/queuedJobs/{jobType}/joboutput")
     ...
     */
    @RequestMapping(method = RequestMethod.POST, value = "/queuedJobs", params = "pause")
    public RedirectView pauseJobQueues(HttpServletRequest request)
    {
        ...
        return new RedirectView("/queuedJobs", true);
    }
     ...
     * @return A redirect pack to the parent page
     */
    @RequestMapping(method = RequestMethod.POST, value = "/queuedJobs", params = "unpause")
