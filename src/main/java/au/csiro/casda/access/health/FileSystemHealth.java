...
public class FileSystemHealth implements HealthIndicator
{
    ...
    private String cacheHomeDir;

    /**
     * Create a new FileSystemHealth instance.
     * 
     * @param depositToolsWorkingDirectory Folder which should be read-write. 
     * @param depositToolsInstallationDirectory Folder which should be readable.
     * @param cacheHomeDir Folder which should be read-write.
     */
    @Autowired
    public FileSystemHealth(@Value("${deposit.tools.working.directory}") String depositToolsWorkingDirectory,
            @Value("${deposit.tools.installation.directory}") String depositToolsInstallationDirectory,
            @Value("${cache.home.dir}") String cacheHomeDir)
    {
        ...
        this.cacheHomeDir = cacheHomeDir;
    }
    ...
    public Health health()
    {
        ...
        addDirectoryCheck(health, "cache.home.dir", cacheHomeDir, true);
        return health.build();
    }
