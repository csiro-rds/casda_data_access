...
/**
 * A data transfer object for the equatorial bounds of a cutout.
 * <p>
 * Copyright 2015, CSIRO Australia. All rights reserved.
 */
public class CutoutBounds
{
    private String ra;
    private String dec;
    ...
    private String[] dimBounds = new String[2];
    private int numPlanes = 1;

    /**
     * Create a new CutoutBounds instance without any details.
     */
    public CutoutBounds()
    {
    }
    ...
    /**
     * Create a new CutoutBounds instance without ySize.
     * 
     * @param ra
     ...
     */
    public CutoutBounds(String ra, String dec, double xSize)
    {
        this.ra = ra;
        this.dec = dec;
        this.xSize = String.valueOf(xSize);
    }

    /**
     * Create a new CutoutBounds instance using BigDecimal values
     * 
     * @param ra
     *            The right ascension of the centre of the cutout image, in decimal degrees.
     * @param dec
     ...
     */
    public CutoutBounds(BigDecimal ra, BigDecimal dec, BigDecimal xSize, BigDecimal ySize)
    {
    ...
    /**
     * Create a new CutoutBounds instance based on an existing CutoutBounds.
     * 
     * @param bounds
     *            The CutoutBounds to be copied.
     */
    public CutoutBounds(CutoutBounds bounds)
    {
    ...
    /**
     * Create a new CutoutBounds instance using string values
     * 
     * @param ra
     *            The right ascension of the centre of the cutout image, in decimal degrees.
     * @param dec
     ...
     *            The height, in decimal degrees, of the cutout image.
     */
    public CutoutBounds(String ra, String dec, String xSize, String ySize)
    {
        this.ra = ra;
        this.dec = dec;
        this.xSize = xSize;
    ...
    /**
     * Creates a new CutoutBounds instance from a single string value matching the output of the toString methd.
     * 
     * @param input
     *            the string representation of the cutout bounds
     */
    public CutoutBounds(String input)
    {
        final int raIndex = 0;
    ...
    public boolean equals(Object obj)
    {
        ...
        CutoutBounds other = (CutoutBounds) obj;
        if (dec == null)
        {
            if (other.dec != null)
            {
