...
<%--
 ...
 <html>
<head>
<title>CSIRO Data Access Portal - CASDA Access Processing Queue</title>
	...
	<div id="wrapper">
		...
		<div id="content">
			<div class="indentRight">
				<a href="/casda_data_access/jobs">Job Queue</a>&nbsp;|&nbsp;<a href="/casda_data_access/logout">logout</a>
			</div>
			<br>
	<fieldset>
		<legend>CASDA Data Access Processing Queue</legend>		
